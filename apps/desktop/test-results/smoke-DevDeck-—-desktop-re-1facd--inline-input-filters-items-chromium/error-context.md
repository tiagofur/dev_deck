...
- Name: smoke.spec.ts >> DevDeck — desktop renderer E2E >> 4. search: inline input filters items
- Location: tests/e2e/smoke.spec.ts:114:7
...
Locator: getByPlaceholder(/Search items/i)
Expected: visible
Timeout: 5000ms
...
Call log:
  ...
  - waiting for getByPlaceholder(/Search items/i)
